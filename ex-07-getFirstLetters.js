...
//entra un array de strings de palabras
//sale un nuevo array de la primera letra de las palabras del array de entrada

function getFirstLetters(anArray){
	var firstLetters = "";
	var word = "";
	var newString = [];
